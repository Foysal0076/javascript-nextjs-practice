  ...
  data: [
    {
      id: 1,
      name: 'Item 1',
      image: '/assets/images/winter-deer.jpg',
      description:
            ...
            new TableRow({
              children: [
                new TableCell({
                  ...
                  children: [
                    new Paragraph({ text: 'ID', style: 'tableHeader' }),
                  ],
                }),
                new TableCell({
                  width: {
                  ...
                  children: [
                    new Paragraph({ text: 'Title', style: 'tableHeader' }),
                  ],
                }),
                new TableCell({
                  width: {
                  ...
                  children: [
                    new Paragraph({ text: 'Image', style: 'tableHeader' }),
                  ],
                }),
                new TableCell({
                  width: {
                ...
                new TableCell({
                  ...
                  children: [
                    new Paragraph({ text: 'Price', style: 'tableHeader' }),
                  ],
                }),
                new TableCell({
                  width: {
...
const CreateWordFile = () => {
  ...
  return (
    <Box>
      <Container>
        <Typography variant='h4' component='h1' my={4} textAlign='center'>
          Export Word File
        </Typography>
        <Box display='flex' justifyContent='center' mb={4}>
          <Button
            variant='contained'
            onClick={() => saveDocument2File(document, 'Test Document.docx')}>
            Export 2 Word
          </Button>
        </Box>
